<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Gracias por registrarte! Antes de comenzar, verifica tu email con el enlace que te enviamos a la dirección de correo proporcionada. Si no recibió el correo electrónico, haz clic en el enlace siguiente.') }}
    </div>
